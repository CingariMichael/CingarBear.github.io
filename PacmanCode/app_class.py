...
# ########################## PLAYING FUNCTIONS ################################# #
    ...
    def playing_update(self):
        ...
        if self.player.ate_pill:
            for enemy in self.enemies:
                if enemy.grid_pos == self.player.grid_pos:
                    # enemy.grid_pos = enemy.starting_pos
                    self.player.current_score += 25
        else:
            for enemy in self.enemies:
                if enemy.grid_pos == self.player.grid_pos:
                    self.remove_life()

        # pygame.mixer_music.load(PAC_EATING_COIN_SOUND)
    ...
    # use this code when implementing portal transportation
    ...
    def draw_pills(self):
        for pill in self.pills:
            pygame.draw.circle(self.screen, RED,
                               (int(pill.x * self.cell_width) + self.cell_width // 2 + TOP_BOTTOM_BUFFER // 2,
                                int(pill.y * self.cell_height) + self.cell_height // 2 + TOP_BOTTOM_BUFFER // 2), 5)
